...
namespace WebApp.SamplePages
{
    ...
    {
        // this static variable is being used in this demo example to hung onto the dummy data.
        public static List<DDLClass> DataCollection;

        protected void Page_Load(object sender, EventArgs e)
        {
            // this event mehtod is executed EACH and EVERY time this page is processed
            ...
            // there is a property test for post back of your page called Page.IsPostBack (Razor: IsPost)
            ...
            if(!Page.IsPostBack)
            {
                ...
                // load the data collection with the dummy data normally this data would come from your database
                ...
                // to sort a List<T>used the method .Sort()
                ...
                // b) assigne the data list field names to the appropriate control properties
        ...
        protected void SubMitButton_Click(object sender, EventArgs e)
        {
            ...
            // this method is concerned with the actions need for the submit button

            // to access the data of a control, you use the appropiate control (object)
            // property (get, set) and access technique

            // for TextBox, Label, Literal use .Text
            // for a list (DropDownList, RadioButtonlist) use of  
            ...
            // for boolean control (RadioButton, CheckBox) use .Checked

            // most controls will use strings except for for boolean controls
            ...
            else
            {
                ...
                //porperty: .SelectedValue
                CollectionList.SelectedValue = submitchoice;

                // demostrate the 3 different access techniques for a list
        ...
        protected void ListSubmit_Click(object sender, EventArgs e)
        {
            ...
            {
                OutputMessage.Text = "Slect a course to view";
            }
            else
            {

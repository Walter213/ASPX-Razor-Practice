...
namespace NorthwindSystem.Data
{
    ...
    public class Product
    {
        ...
        [Range(0.00,double.MaxValue, ErrorMessage ="Unit Price 0 dollars or greater")]
        public decimal? UnitPrice { get; set; }
        [Range(0, Int16.MaxValue, ErrorMessage = "Units In Stcok 0 or greater")]
        public Int16? UnitsInStock { get; set; }
        [Range(0, Int16.MaxValue, ErrorMessage = "Units on order 0 or greater")]
        public Int16? UnitsOnOrder { get; set; }
        [Range(0, Int16.MaxValue, ErrorMessage = "Reorder Level 0 or greater")]
